    ...
    <main class="max-w-lg mx-auto px-4 pb-8">
      ...
      <div v-if="step === 5" class="space-y-4">
        <div class="bg-white rounded-2xl border border-border p-5">
          ...
          <!-- Disclaimer -->
          <div class="bg-warning/5 border border-warning/20 rounded-xl p-3 text-xs text-warning">
            <div class="flex items-start gap-2">
              <svg class="w-4 h-4 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
              </svg>
              <p>بعد الإرسال، سيتم تحليل البيانات المالية تلقائياً. قد يستغرق التحليل بضع دقائق.</p>
            </div>
          </div>
        </div>
